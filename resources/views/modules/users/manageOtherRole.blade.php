...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function computePermissions() {
    ...
    const createDeleteRoles = ['admin','super_admin','superadmin','super-admin','director','principal'];
    const writeRoles = ['admin','super_admin','superadmin','super-admin','director','principal'];
